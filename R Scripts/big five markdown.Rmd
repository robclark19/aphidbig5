...
#### Alex ####
#m1 = glmer.nb(Counts ~ Biotype * Plant * virus + Run + (1|ID..), nAGQ=0, data = bf)
# Singular fit, evidence for no RE, goes for intercept & slopes
...
#### Alex ####
# Not the main dataset, seems to be supplementary
