...
```{r tab.cap="Table S1: Analysis of Deviance for aphid counts after one week"}
...
new.count.mod <- readRDS("../Models/table2_mod.rds")
...
```{r tab.cap="Table S1: Analysis of Deviance for preference and performance"}

pxp.mod <- readRDS("../Models/table3_mod.rds")
format_anova(pxp.mod)
